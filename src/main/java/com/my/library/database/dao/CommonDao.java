...
import com.my.library.database.models.BaseModel;
import com.my.library.utils.FxmlUtils;
import com.my.library.utils.exceptions.ApplicationException;
...
import static com.my.library.utils.FxmlUtils.*;
...
public class CommonDao {
    ...
    public <T extends BaseModel, I> void refresh(BaseModel baseModel) throws ApplicationException {
        try {
            ...
            LOGGER.warn(e.getCause().getMessage());
            throw new ApplicationException(getResourceBundle().getString("error.refresh"));
        } finally {
            this.closeDbConnection();
        }
    }
    ...
    public <T extends BaseModel, I> void delete(BaseModel baseModel) throws ApplicationException {
        try {
            ...
            LOGGER.warn(e.getCause().getMessage());
            throw new ApplicationException(getResourceBundle().getString("error.delete"));
        } finally {
            this.closeDbConnection();
        }
    }
    ...
    public <T extends BaseModel, I> T findById(Class<T> cls, Integer id) throws ApplicationException {
        try {
            ...
            LOGGER.warn(e.getCause().getMessage());
            throw new ApplicationException(getResourceBundle().getString("error.not.found"));
        } finally {
            this.closeDbConnection();
        }
    }
    ...
    public <T extends BaseModel, I> List<T> queryForAll(Class<T> cls) throws ApplicationException {
        try {
            ...
            LOGGER.warn(e.getCause().getMessage());
            throw new ApplicationException(getResourceBundle().getString("error.not.found.all"));
        } finally {
            this.closeDbConnection();
        }
    }
    ...
    public <T extends BaseModel, I> Dao<T, I> getDao(Class<T> cls) throws ApplicationException {
        try {
            ...
            LOGGER.warn(e.getCause().getMessage());
            throw new ApplicationException(getResourceBundle().getString("error.get.dao"));
        } finally {
            this.closeDbConnection();
        }
    }
